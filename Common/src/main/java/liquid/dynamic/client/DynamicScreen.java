...
public class DynamicScreen extends AbstractContainerScreen<DynamicContainer> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Constants.ModId, "textures/dynamic_gui.png");
    private final int textColor = Integer.decode(LiquidConfig.colorInText);

    public DynamicScreen(DynamicContainer $$0, Inventory $$1, Component $$2) {
        super($$0, $$1, $$2);
        ...
        this.titleLabelY = 7;
        this.inventoryLabelX = $$0.getPlayerSlots(size, 0, 0).x;
    ...
    protected void renderBg(PoseStack poseStack, float v, int i, int i1) {
        ...
        renderBgTexture(poseStack, new Rectangle(x, y, imageWidth, imageHeight), 0xFFFFFFFF);
        RenderSystem.setShaderTexture(0, new ResourceLocation("textures/gui/container/hopper.png"));

        for (Slot slot : getMenu().slots) {
            this.blit(poseStack, x + slot.x - 1, y + slot.y - 1, 43, 19, 18, 18);
        }
    }
