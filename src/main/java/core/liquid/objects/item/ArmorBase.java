...
public class ArmorBase<T extends ArmorItem> {
    ...
    public ArmorBase(PropertyDispatch.TriFunction<ArmorMaterial, EquipmentSlot, Item.Properties, T> armor, ArmorMaterial material, Item.Properties properties) {
    ...
    public static <T extends ArmorItem> boolean isFullSet(LivingEntity entity, ArmorBase<T> armor) {
    ...
    public static <T extends ArmorItem> boolean hasPart(LivingEntity entity, ArmorBase<T> armor, EquipmentSlot target) {
    ...
    public static <T extends ArmorItem> boolean isContainsAnyPart(LivingEntity entity, ArmorBase<T> armor) {
        ItemStack head = entity.getItemBySlot(EquipmentSlot.HEAD);
        ItemStack chest = entity.getItemBySlot(EquipmentSlot.CHEST);
        ItemStack legs = entity.getItemBySlot(EquipmentSlot.LEGS);
        ItemStack feet = entity.getItemBySlot(EquipmentSlot.FEET);
    ...
    public void registerModels(String modid, String name) {
        AutoModel.genModels.add(new ResourceLocation(modid, name + "_helmet"));
        AutoModel.genModels.add(new ResourceLocation(modid, name + "_chest"));
        AutoModel.genModels.add(new ResourceLocation(modid, name + "_legs"));
        AutoModel.genModels.add(new ResourceLocation(modid, name + "_boots"));
    }
